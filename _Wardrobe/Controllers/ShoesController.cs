...
namespace _Wardrobe.Controllers
{
    public class ShoesController : Controller
    {
        ...
        {
            var shoes = db.Shoes.Include(s => s.Season);
        ...
        public ActionResult Create([Bind(Include = "ShoeID,ShoeName,Photo,Type,Color,Occasion,SeasonID")] Shoe shoe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShoeID,ShoeName,Photo,Type,Color,Occasion,SeasonID")] Shoe shoe)
        {
            if (ModelState.IsValid)
            {
